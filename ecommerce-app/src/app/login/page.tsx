...
export default function LoginPage() {
  const loginHandle = async (formData: FormData) => {
    ...
    if (!response.ok) {
      ...
      return redirect("/login?error=" + error.error)
    }
    ...
    return (
        <div className="font-[sans-serif] bg-gradient-to-r from-black to-gray-500 text-gray-800">
  <div className="min-h-screen flex fle-col items-center justify-center lg:p-6 p-4">
    <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
      ...
      <Link href={"/"}>
        ...
        <h2 className="text-2xl font-extrabold lg:leading-[50px] text-white">
      ...
      <form action={loginHandle} className="bg-white rounded-xl px-6 py-8 space-y-6 max-w-md md:ml-auto w-full">
