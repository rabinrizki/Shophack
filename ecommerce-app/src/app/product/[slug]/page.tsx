...
export default async function DetailProducts(props : Props) {

    const data = await getDetailProduct(props.params.slug)
  ...
  <div className="bg-gradient-to-r from-gray-600 via-gray-900 to-gray-900 md:min-h-[600px] grid items-start grid-cols-1 lg:grid-cols-5 md:grid-cols-2">
    ...
    <div className="lg:col-span-2 bg-gray-100 py-6 px-8 h-full">
      ...
      <div className="mt-8">
        ...
        <p className="text-gray-800 text-3xl font-bold mt-4">{rupiah(data?.price)}</p>
      </div>
      <div className="mt-8">
      ...
      <div className="flex flex-wrap items-center text-sm text-gray-800 mt-8">
        ...
        Free delivery on order Rp5.000.000
      </div>
    </div>
  </div>
  <div className="mt-8 max-w-5xl px-9">
    <div className="mt-8 mb-8">
      <h1 className="text-lg font-bold text-gray-800 mt-10">Product Description</h1>
